...
* **Explaining personality predictions from spending data.** Currently working on a project to explain personality predictions from spending records with Prof. [Sandra Matz](https://sandramatz.com/) and Prof. [Robert Farrokhnia](https://ra.schlosser.io/) (both affiliated at Columbia University, New York City). 
