...
<div style="display: flex; flex-wrap: wrap; gap: 20px; justify-content: center;">
  ...
  <div style="flex: 0 0 45%;">
    ...
    Contributed to QuantumBlack's Frontline.ai module, an integrated demand & supply planning engine using a.o. time-series forecasting & optimization. Applied this solution across industries, from call center planning to energy tank maintenance & pharma retail staffing.</p>
