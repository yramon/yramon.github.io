...
* **Explaining personality predictions from spending data.** Currently working on a project to increase understanding of how personality traits can be inferred from spending records with [Prof. Sandra Matz](https://sandramatz.com/){:target="_blank"} and [Prof. Robert Farrokhnia](https://ra.schlosser.io/){:target="_blank"} (both affiliated at Columbia University, New York City). 
